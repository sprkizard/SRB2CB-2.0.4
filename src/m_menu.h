...
#define IT_WHITESTRING      48     // little string in white // SRB2CBTODO: THIS ACTUALLY MAKES THINGS YELLOW?!!!
...
#ifdef HWRENDER
extern menu_t OGL_LightingDef, OGL_FogDef, OGL_ColorDef, OGL_DevDef, OGL_TexDef;
#endif
