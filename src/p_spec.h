...
//
// SoM: Specials that modify map geometry, etc., need to be done before other specials
#ifdef ESLOPE
...
void T_TimedThinker(levelspecthink_t *timed); // SRB2CBTODO: TIMEDTODO
...
void Add_Pusher(pushertype_e type, fixed_t x_mag, fixed_t y_mag, mobj_t *source, long affectee, long referrer, int exclusive, int slider);
