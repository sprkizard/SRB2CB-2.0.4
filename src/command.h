...
// don't insert a command into the buffer, just do immediately
...
typedef enum
{
	...
	CV_NOTINNET = 32,     // some variables can't be changed in the network but isn't a netvar (ex: splitscreen)
	...
	CV_NOSHOWHELP = 512,  // Don't show variable in the HELP list
...
typedef struct consvar_s //NULL, NULL, 0, NULL, NULL |, 0, NULL, NULL, 0, 0, NULL
{
	...
	USHORT netid; // used internaly : netid for send end receive
