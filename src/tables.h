...
// SRB2CBTODO: Convert an angle into a degree
#define ANGLE_TO_DOUBLE(x) (((double)(x)) / ((double)ANG45/45))
#define ANGLE_TO_FLOAT(x)  (((float)(x)) / ((float)ANG45/45))
#define ANGLE_TO_INT(x)  (((int)(x)) / ((int)ANG45/45))
...
FUNCMATH angle_t FixedAngleC(fixed_t fa, fixed_t factor); // SRB2CBTODO: Causes issues on certain compilers?!
