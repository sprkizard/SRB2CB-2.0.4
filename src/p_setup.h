...
extern boolean LoadingCachedActions;
...
typedef struct
{
	...
	int numpics;
	int speed;
	int resolution; // What is the resolution of this flat so we can draw it?
	int ispng;
} levelflat_t;
...
void P_LoadingScreen(const char *msg, short percent);
