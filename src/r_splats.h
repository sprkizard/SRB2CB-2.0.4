...
//#ifdef USEASM
// Needs ASM code for drawing FLOORSPLATS in software, 
// should be replaced with a better method, which isn't going to happen
//#define FLOORSPLATS // SRB2CBTODO: Support FLOORSPLATS in OpenGL
//#endif
