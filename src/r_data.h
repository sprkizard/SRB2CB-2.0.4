...
typedef struct
{
	...
	boolean tx; // special boolean so we know to look in  a specific wad file for this texture
	USHORT wadlocation; // which wad is this texture from?
	short ispng;
} texture_t;
...
// Load TX_ definitions, create lookup tables
