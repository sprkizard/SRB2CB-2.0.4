...
typedef enum
{
	/// Software, render the game using the CPU
	render_soft = 1,

	/// OpenGL, render the game in real time 3D
	render_opengl = 2,

	/// None, don't render anything, for dedicated servers
	render_none = 3
} rendermode_t;
...
/**	\brief don't use all of OpenGL's features in this mode
 */
extern boolean minigl;
