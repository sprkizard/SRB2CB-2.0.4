...
const char *text[NUMTEXT] =
{
	...
	PREFIX_WARN "Can't delete %s",                                                    //CANNOTDELETE
	"Press ESC to abort\n",                                                        //ESCABORT
	...
	"\2num:%2d  node:%2d  %s\n",                                                   //PLAYERNUM
	"num:%2d  node:%2d  %s\n",                                                     //SERVERPLAYERNUM
	"There is no player or bot named \"%s\"\n",                                  //NOPLAYERNAMED
	"%.2d: %*s",                                                                   //NODESCMDTXT
	" - %.2d",                                                                     //NODESCMDTXT2
	" - %s",                                                                       //NODESCMDTXT3
	...
	"Too many bans! More than 255 players are currently banned, the limit is 255\n",           //TOOMANYBANS
	"You are not the server.\n",                                                   //YOUARENOTTHESERVER
	"Kick a player:\n  Kick <playername> or <playernum>\n",                           //KICKHELP
#ifdef JTEBOTS
	"Kick a player, a bot, or ALLBOTS:\n  Kick <playername> or <playernum> or <allbots>:\n",     //KICKBOTHELP
#endif
	...
	"This level doesn't support %s mode!\n", //GTNOTSUPPORTED
	"This level doesn't support Single Player mode\n",                //SPNOTSUPPORTED
	...
	PREFIX_WARN "patch from a different SRB2 version (%d), ", //WRONG_VERSION_WARNING
	"version 2.0 is supported\n", //SUPPORTED_VERSION // SRB2CBTODO: should be versionstring
	...
	"Can not teleport: Player is not in level\n",                                  //PDEAD_ETC
	"Teleport to a location:\n    Teleport -x <value> -y <value> -z <value>\n", //TELEPORT_HELP
	...
	PREFIX_WARN "Game must be restarted to record statistics.\n", //GAMEMODIFIED
	"Can't load file, try adding files before starting a network game\n",   //FILE_NOT_FOUND
	...
	PREFIX_WARN "State Cycle Detected\n", //CYCLE_DETECT
	...
	"===========================================================================\n"
	"                     Welcome to SRB2CB!\n"
	"                     This console log is updated\n"
	"                     every time you start the game\n"
	"===========================================================================\n", //WELCOMETEXT

	"M_LoadDefaults: Load system defaults.\n",         //M_LOAD
	"Z_Init: Init Zone memory allocation system. \n",  //Z_INIT
	"W_Init: Init WADfiles.\n",                        //W_INIT
	"M_Init: Init miscellaneous info.\n",              //M_INIT
	"R_Init: Init SRB2 display system\n",             //R_INIT
	...
	// This includes the version number of the game
	"Sonic Robo Blast 2:" VERSIONSTRING, //SRB2TITLE
};
